...
namespace Masquerade.Orchestrators
{
    public class GameOrchestrator
    {
        ...
        private static List<string> MaskDescriptionsLong = new List<string>
        {
        ...
        private static List<string> MaskDescriptionsShort = new List<string>
        {
            "Dotted",
            "Leaf",
            "Mechanical",
        ...
        {
            var maskDescriptions = game.Settings.UseLongMaskDescriptions ? MaskDescriptionsLong : MaskDescriptionsShort;
